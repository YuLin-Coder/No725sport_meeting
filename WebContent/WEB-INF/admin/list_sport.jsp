 ...
 <div class="layui-col-md12">
       <div class="layui-card">
          ...
          <div class="layui-card-body">
           <form action="<%=path %>/findAdminBySportMap" method="post">
           ...
           <input type="submit" class="layui-btn layui-btn-primary layui-btn-sm" value="查询" />
            <a href="<%=path %>/toAddSportAct" class="layui-btn layui-btn-sm layui-btn-normal " target="mainFrame"><i class="layui-icon">新增</i></a>    	
                ...
                <c:forEach items="${pageInfo.list}" var="p" >
				    <tr>
				      ...
				      <%--   <td>${p.detail }</td> --%>
				       ...
				       <td>${p.amount }</td>
				    	<td>      
             				<a href="<%=path %>/toUpdateSportAct?id=${p.id}" class="layui-btn layui-btn-sm layui-btn-normal " target="mainFrame"><i class="layui-icon">&#xe642;</i></a>
