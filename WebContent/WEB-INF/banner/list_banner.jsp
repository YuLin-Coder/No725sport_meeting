 ...
 <div class="layui-col-md12">
       <div class="layui-card">
          ...
          <div class="layui-card-body">
           <form action="<%=path %>/findByBannerMap" method="post">
				    ...
				    <tr>
				       ...
				       <td>${p.title }</td>
				        ...
				        <td>${p.url }</td>
				      	<td>${p.note }</td>
				    	<td>      
             				<a href="<%=path %>/toUpdateBannerAct?id=${p.id}" class="layui-btn layui-btn-sm layui-btn-normal " target="mainFrame"><i class="layui-icon">&#xe642;</i></a>
	                   ...
	                   url:"deleteBannerAct",
	                    ...
	                    success:function (data) {
	                 	layer.msg('删除成功',{
	                	  ...
	                	  window.location.href="${pageContext.request.contextPath}/bannerPage";//相当于刷新界面   
	                  }); 
