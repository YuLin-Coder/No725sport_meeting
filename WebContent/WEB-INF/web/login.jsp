...
<body>
    ...
    <form action="<%=path %>/webLogin" method="post" onSubmit="return tijiao(this)" id="loginForm" name="loginForm">
    ...
    <div class="layadmin-user-login-main">
      ...
      <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
        ...
        <div class="layui-form-item">
         ...
         <button type="submit" id="denglu" class="layui-btn layui-btn-normal layui-btn-fluid">登录</button>
          
        </div>
        <!--   <div class="layui-form-item">
                  <button type="button" onclick="location.href='toWebRegister'" class="layui-btn  layui-btn-fluid">注册</button>
