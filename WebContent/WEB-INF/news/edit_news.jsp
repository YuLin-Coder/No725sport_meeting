    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md12">
        <div class="layui-card" >
          <div class="layui-card-header">修改新闻公告</div>
          ...
          <div class="layui-form" lay-filter="">
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="title" id="title" value="${record.title }"  lay-verify="required" lay-verType="tips" class="layui-input">
                </div>
              </div>
                ...
                <div class="layui-form-item">
				    ...
				    <div class="layui-input-inline uploadHeadImage">
				        <div class="layui-upload-drag" id="headImg">
				          <img class="layui-upload-img headImage" src="upload/${record.photo}" id="demo1" style="width:100px;height:100%">
				            <p id="demoText"></p>
				            <p>点击上传图片</p>
				        </div>
				    </div>
             ...
             <div class="udietor">
			    <script id="editor" type="text/plain" style="width:1024px;height:500px;">${record.content }</script>
			</div>
              <br>
              <div class="layui-form-item">
                <div class="layui-input-block">
                
            <button class="layui-btn" type="submit" id="update" onclick="submit()">确认修改</button>
...
//建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
	...
	function submit(){
		...
		$.ajax({
			  type: 'POST',
			  url: '${pageContext.request.contextPath}/updateNewsAct',
			  data: {"content":ud,"title":title,"id":id,"photo":photo},
			  /* dataType: "json", */
